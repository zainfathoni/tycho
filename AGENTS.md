...
- `bundle exec bin/tycho metrics interactions [--from TIME] [--to TIME] [--timezone ZONE] [--json]`: list timestamp-only records of explicit human interactions (prompt submitted, inquiry answered, run taken over).
